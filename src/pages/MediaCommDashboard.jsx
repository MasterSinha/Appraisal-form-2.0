...
export default function MediaCommDashboard({ fixedRole }) {
 ...
 ? form.innovRows.reduce((t, r) =>t + clampScore(r.score, r.max || 4), 0)
 ...
 ...(role === "director" ? [{ id: "departments", label: "Manage Programs", sub: "HOD programs for your school" }] : []),
  ...
  return (
    <DashboardLayout
      ...
      mainStyle={{ flex: 1, padding: "40px", display: "flex", flexDirection: "column", gap: 16, overflowX: "hidden", maxWidth: 1600, margin: "0 auto", width: "100%", position: "relative" }}
      sidebar={(
        <DashboardSidebar
          appInfo={APP_INFO}
          navItems={navItems}
