...
<p style={{ margin: "4px 0 0", color: "#64748b", fontSize: 13 }}>{ENGINEERING_SCHOOLS.length} Engineering Schools - {APP_INFO.UNIVERSITY_NAME} - AY {sessionStorage.getItem("academicYear") || APP_INFO.DEFAULT_AY}</p>
</div>
