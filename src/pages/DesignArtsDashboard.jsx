...
import { emptyDesignArtsForm, ALL_ARRAY_KEYS, titleCase, calculateDesignArtsTotals, getDesignArtsEffectiveMaxScores, validateDesignArtsBeforeSubmit, mergeForm, preserveSavedReviewScores, normalizeSubmittedCreativeFormForReview, designArtsSchoolName, getPartBSectionsForSchool, PART_A_SECTIONS, PART_C_SECTIONS, PART_D_SECTIONS, PART_E_SECTIONS, DesignArtsForm, DesignArtsAuthorityReviewPanel, SectionSelector, AccuracyCheckbox, CompactAuthoritySummaryCard, isReviewerReviewComplete, normalizeScoresForSubmit, summaryRow, b8summaryRow, SECTION_OPTIONS, SummaryBox, WorkflowTracker, ACCENT, ACCENT2, PART_A_MAX, PART_B_MAX, PART_D_MAX, PART_E_MAX, GRAND_MAX, userInitials } from "../features/faculty-appraisal";
...
export default function DesignArtsDashboard({ fixedRole }) {
 ...
 const isInScope = (item) =>FORM_SCHOOL_CODES[FORM_TYPES.DESIGN_ARTS].includes(getSchoolKey(item.school || item.info?.school));
  ...
  const navItems = [
    ...
    ...(role === "director"
      ...
      : role !== "faculty"
        ...
        : []),
    // SoD/SoAA are organized into programs, not departments - one HOD can cover multiple programs.
        ...
        <div className="appraisal-year-loading-overlay" role="status" aria-live="polite">
          <div className="appraisal-year-loading-card">
            ...
            <div className="appraisal-year-loading-textwrap">
              ...
              <div className="appraisal-year-loading-subtext">Fetching {schoolDisplayName} submissions</div>
              <div className="appraisal-year-loading-dots"><span /><span /><span /></div>
            </div>
          </div>
        </div>
...
<button
 ...
 {!loadingQueue && activeQueue.length > 0 && filteredQueue.length === 0 && (
