...
<td style={TDS_DIR}><DirInput val={getDir("projects", i, "dir")} max={projectGuidanceRowMax(r)} disabled={!rowHasReviewableData("projects", r, docs, `proj-${i}`)} onChange={v =>setDir("projects", i, "dir", v)} /></td>
</tr>
 ))}
</tbody>
</table>
