...
<td style={TDS_HOD}><HodInput val={get("feedback", i, "hod")} max={SCORE_LIMITS.feedbackAverage} disabled={!rowHasReviewableData("feedback", r, docs, `fb-${i}`)} onChange={v =>set("feedback", i, "hod", v)} /></td>
</tr>
 ))}
</tbody>
</table>
