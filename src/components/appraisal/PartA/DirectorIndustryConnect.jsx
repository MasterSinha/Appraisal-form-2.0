...
export default function DirectorIndustryConnect({ ctx }) {
...
<td style={TDS_DIR}><DirInput val={getDir("industry", i, "dir")} max={10} disabled={!rowHasReviewableData("industry", r, docs, `ind-${i}`)} onChange={v =>setDir("industry", i, "dir", v)} /></td>
</tr>
 ))}
</tbody>
</table>
