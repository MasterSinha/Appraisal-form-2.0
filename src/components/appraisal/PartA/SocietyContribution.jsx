...
<td style={TDS_HOD}><HodInput val={societyRowLocked(r) ? "0" : get("society", i, "hod")} max={20} disabled={societyRowLocked(r) || !rowHasReviewableData("society", r, docs, `soc-${i}`)} onChange={v =>set("society", i, "hod", v)} /></td>
</tr>
 ))}
</tbody>
</table>
