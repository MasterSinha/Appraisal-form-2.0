...
<tbody>
 {sectionEmpty("courseFile") ? emptySectionRow(7) : rows(courseFile).map((r, i) =>(
...
<td style={TDS_DIR}><DirInput val={getDir("courseFile", i, "dir")} onChange={v =>setDir("courseFile", i, "dir", v)} max={SCORE_LIMITS.courseFileRow} disabled={!rowHasReviewableData("courseFile", r, docs, [`courseFile-${i}`, `cf-${i}`])} /></td>
</tr>
 ))}
</tbody>
</table>
